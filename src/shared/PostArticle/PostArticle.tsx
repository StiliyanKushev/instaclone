                        ...
                        <div className={styles.commentItemLeftSide}>
                            ...
                            <div>
                                <Header className={styles.commentItemHeader}>
                                    <span>{this.props.post?.fullViewPostData.commentsList[index].creator}</span>{" "}
                                    {this.props.post?.fullViewPostData.commentsList[index].content}
                                </Header>
                                {!this.props.post?.fullViewPostData.commentsList[index].isDescription && (
                    ...
                    <Grid.Row className={styles.row}>
                        <div className={styles.leftCol}>
                            <Image
                                ...
                                size="huge"
                                src={`data:${
                                    this.props.post?.fullViewPostData.source.contentType
                                };base64,${Buffer.from(
                                    this.props.post?.fullViewPostData.source.data
                                ).toString("base64")}`}
                            />
                        </div>
                        <div className={styles.rightCol}>
                                    ...
                                    {({ width, height }) => {
                                        return (
                                            <List
                                                ...
                                                rowCount={this.props.post?.fullViewPostData.commentsList.length as number}
                                                overscanRowCount={3}
                                            />
                                        );
                                    }}
                            ...
                            <Segment attached className={styles.actionSegment}>
                                <Menu className={styles.postMenu}>
                                    <Item className="left">
                                        <Icon
                                            ...
                                            id={!this.props.post?.fullViewPostData.isLiked ? `${styles.likeOutline}` : ''} className={`${styles.likeBtn} ${styles.iconBtn} heart ${this.props.post?.fullViewPostData.isLiked ? '' : 'outline'}`}
                                            size="big"
                                        ></Icon>
                                        <Icon
                                ...
                                <Header className={styles.likes} size="tiny">
                                    {this.props.post?.fullViewPostData.likesCount} likes
                                </Header>
                            </Segment>
                            <Segment
